                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="tex"  name="full_mark[]" value="{{ $edit->full_mark }}" class="form-control"  > 
                                            </div>
                                        </div>
                                    </div> <!-- col-md-5 -->
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="tex"  name="pass_mark[]" value="{{ $edit->pass_mark }}" class="form-control"  > 
                                            </div>
                                        </div>
                                    </div> <!-- col-md-5 -->
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="tex"  name="subjective_mark[]" value="{{ $edit->subjective_mark }}" class="form-control"  > 
                                            </div>
                                        </div>
                                    </div> <!-- col-md-5 -->
            ...
            <div class="form-row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <h5>Full Mark<span class="text-danger">*</span></h5>
                        <div class="controls">
                            <input type="tex"  name="full_mark[]" class="form-control"  > 
                        </div>
                    </div>
                </div> <!-- col-md-5 -->
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <h5>Pass Mark<span class="text-danger">*</span></h5>
                        <div class="controls">
                            <input type="tex"  name="pass_mark[]" class="form-control"  > 
                        </div>
                    </div>
                </div> <!-- col-md-5 -->
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <h5>Subjective Mark<span class="text-danger">*</span></h5>
                        <div class="controls">
                            <input type="tex"  name="subjective_mark[]" class="form-control"  > 
                        </div>
                    </div>
                </div> <!-- col-md-5 -->
