    ...
    <div class="container-full">
      ...
      <section class="content">
           ...
           <div class="box-body">
             <div class="row">
               <div class="col">
                ...
                <div class="controls">
                    <input type="name" name="name" class="form-control" value="{{ $editData->name }}" required > </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <div  class="controls">
                    <img id="showImage" src="{{ (!empty($user->image)) ? url('upload/user_images/'.$user->image) : url('upload/no_image.jpg') }}" style="height: 100px; width: 100px; border: 1px solid #000000;">
                </div>
            </div>
